...
public interface Consts {
	String MTONS_CONFIG = "/unzen.properties";
	...
	String ENTITY_TYPE = "ENTITY_NEWS";
	
	String FILEPATH = "F:\\word\\";
	
	String AVATARPATH = "F:\\word\\avatar\\";
	/** 图片类型 */
	String IMGTYPE = ".jpg";
	
	Map<Long,List<String>> PATHS = new HashMap<Long, List<String>>();
	
	Map<Long,Long> requests = new HashMap<Long,Long>();
}
