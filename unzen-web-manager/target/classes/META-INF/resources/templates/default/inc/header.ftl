    ...
    <div class="container">
        <nav class="navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${base}/unzen/">
                    <img src="${base}/static/default/images/vaygos (8).png"/>
                </a>
            </div>
            <div class="collapse navbar-collapse">
                <!--<ul class="nav navbar-nav">
					...
					<#list channels as row>
						<li>
							<a href="${base}/channels/channel/${row.id}" nav="${row.name}">${row.name}</a>
						</li>
					</#list>
                </ul>-->
				...
				<#if profile??>
				 	<!--<li>
                    	<a href="${base}" class="btn i-icon">
                    		<i class="btn-large icon  icon-home"></i>
                    	</a>
                    </li>-->
				 	<li>
                    	<a href="${base}/post/new" class="btn i-icon" title ="发现">
                    		<i class="btn-large icon icon-compass"></i>
                    	</a>
                    </li>
				 	<li>
                    	<a href="${base}/post/new" class="btn i-icon" title="通知">
                    		<i class="btn-large icon icon-bell"></i>
                    	</a>
                    </li>
                    <li>
                    	<a onclick="upload()" class="btn i-icon" title="发帖">
                    		<i class="btn-large icon icon-note"></i>
                    	</a>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            <li>
                            	<a href="${base}/user">
                                	<span class="glyphicon glyphicon-user"></span>主页
                            	</a>
                            </li>
                            <li>
                            	<a href="${base}/user/profile">
                                	<span class="glyphicon glyphicon-heart"></span>喜欢
                                	<div class="heart-size">5</div>
                            	</a>
                            </li>
                            <li>
                               <a href="${base}/user/profile">
                            		<span class="glyphicon glyphicon-list-alt"></span>关注
                                	<div class="heart-size">5</div>
                            	</a>
                            </li>
                            <li>
            		 			<a href="${base}/user/profile">
                        			<span class="glyphicon glyphicon-cog"></span>编辑资料
                                	<div class="heart-size">5</div>
                            	</a>
                            </li>
                            <li>
                            ...
                            <@shiro.hasPermission name="admin">
                                <li><a href="${base}/back/admin">后台管理</a></li>
                            </@shiro.hasPermission>
