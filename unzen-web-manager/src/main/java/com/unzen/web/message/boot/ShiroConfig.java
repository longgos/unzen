...
import com.unzen.web.message.shiro.authc.AccountSubjectFactory;
import com.unzen.web.message.shiro.realm.AccountRealm;
...
//        shiroFilter.setFilterChainDefinitions("");
         ...
         * 登陆成功后跳转的url
         */
        shiroFilter.setSuccessUrl("/unzen");
        /**
         * 没有权限跳转的url
         */
        ...
        hashMap.put("/unzen/**", "user");
        hashMap.put("/user*", "user");
        hashMap.put("/user/**", "user");
        hashMap.put("/post/**", "user");
        hashMap.put("/channels/**", "user");
