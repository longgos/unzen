<#include "/default/utils/import.ftl"/>

<@layout "我的主页">

<div class="row streams">
<div class="col-xs-12 tn-list">
		<div class="border-a">帖子</div>
		<div>喜欢</div>
		<div>关注</div>
	</div>
    <div class="col-xs-12 col-md-6 side-left" style="margin-top:10px;">
                            ...
                            <li class="li-group-coln">
                               ...
                               <!-- href="${base}/post/like?postId=${row.id}" -->
	                               <a onclick="hots(this,${row.id})" class="btn i-icon">
			                    		<i class="glyphicon glyphicon-pencil" title="热度"></i>
			                       </a>
	                               <a href="${base}/post/new" class="btn i-icon">
			                    		<i class="glyphicon glyphicon-trash" title="评论"></i>
			                       </a>
			                       <abbr class="timeago">${timeAgo(row.created)}</abbr>
                               </div>
    ...
    <div class="col-xs-12 col-md-4 hidden-xs side-right"style="margin-top:10px;">
...
<script type="text/javascript">
	...
	$(".tn-list>div").click(function(){
		$("div").removeClass("border-a");
